...
export default function AdminSidebar({ userName, userEmail, pendingCount }: { userName: string; userEmail: string; pendingCount?: number }) {
          ...
          <div key={section.label}>
            ...
            <div className="flex flex-col gap-0.5">
              {section.items.map((item) => {
                ...
                const showBadge = item.href === "/admin/organizadores" && (pendingCount ?? 0) > 0;
                return (
                  <Link
                    key={item.href}
                    href={item.href}
