...
export function StarButton({
  ...
  const sharedClassName = cn(
    ...
    dark ? "text-white hover:opacity-90" : "text-[#0a0a0a] hover:opacity-90",
    className,
  );
